...
public class AdminServlet extends HttpServlet {
    ...
    @Inject CapedwarfVelocityContext velocityContext;
    ...
    private void serveVelocityPage(HttpServletRequest req, HttpServletResponse resp) throws Exception {
        ...
        System.out.println("velocityContext = " + velocityContext);

        velocityContext.init(req);
        Context context = velocityContext;
//        Context context = new CapedwarfVelocityContext(manager, req);
